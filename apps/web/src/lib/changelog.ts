...
export const CHANGELOG: Release[] = [
  {
    ...
    notes: [
      ...
      'And if you would rather not think about it: turn on Follow the sun under Appearance and your theme takes its day half from sunrise and its after-dark half once the sun goes down. Sunset moves through the year, so it arrives later in June than in December. Off unless you ask for it.',
