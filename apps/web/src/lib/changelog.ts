...
export const CHANGELOG: Release[] = [
  {
    ...
    notes: [
      'Each couple holds one colour at both ends of the day: Terracotta and Ember, Mango Sunshine and Lantern, Sage Grove and Forest Night, Lavender and Indigo Night, Barbie Pink and Afterparty, Eggshell and Graphite. Twelve lights in all, six for the day and six for after it, and Appearance shows each couple on one row.',
      'Five of those are new. Ember is Terracotta banked down to coals. Lantern carries Mango\'s gold into a warm lit room. Barbie Pink is Mattel\'s magenta on paper that is never white, and Afterparty is that same pink lit from a plum-black room. Graphite is Eggshell with the lights off, almost no colour at all. Espresso has gone; if it was yours, you are on Ember now and there is nothing to do.',
      'Cards have edges in the dark now. They used to lean on a shadow that a dark screen swallowed, so they floated on the page. Every card, sheet and menu now holds its edge in either half of the day.',
      'If you would rather not choose at all, turn on Follow the sun under Appearance. Your theme takes its day half from sunrise and its after-dark half once the sun goes down. Sunset moves through the year, so it arrives later in June than in December. Off unless you ask for it.',
    ],
    howTo: [
      'Open Me, then Appearance, and tap any theme to switch instantly.',
    ],
    art: ['darkthemes', 'themes'],
  },
  {
    version: '1.4.0',
    date: '2026-08-17',
    major: true,
    title: 'A line straight to the person who makes it',
    notes: [
      'Whatever is good about Harmony is good because people said what was not working for them. Me now has a direct line to the person who makes it, so that can carry on.',
      'Send a bug, a feature you want, or a thought you have not finished having. Bugs get fixed quickly and ideas are weighed for the next version. Everything is read properly.',
      'Your version and the device you are holding travel with the message, so there is no need to describe the screen. Nothing about your areas, habits or notes goes with it.',
      'Offline, or the message could not get through? It waits on your device and sends itself once you are back. Write it and forget it.',
      'Replies arrive at the email you signed up with, so there is nothing to check and nothing to miss.',
    ],
    howTo: [
      'Open Me, scroll to "Make Harmony Yours", and pick whether it is a bug or an idea.',
    ],
    art: ['message'],
  },
  {
  ...
  },
  {
    ...
    howTo: [
      ...
      'Open Me, then Appearance, and tap any theme to switch instantly. Pairs sit on the same row.',
    ],
