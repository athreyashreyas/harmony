...
- **Made yours.** Eight themes, synced across devices: five by day (Terracotta, Mango Sunshine, Sage Grove, Lavender, Rose Quartz) and three after dark (Indigo Night, Espresso, Forest Night). Harmony brings its own calendar, time, and choice pickers too, so every choice stays in the app rather than dropping to the OS.
