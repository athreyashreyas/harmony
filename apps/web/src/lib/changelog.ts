...
export const CHANGELOG: Release[] = [
  {
    ...
    notes: [
      ...
      'Sort your Home list by time of day (the default), priority, name, or what is still to do.',
    ...
    howTo: [
      ...
      'Order your list with the sort control above it: time of day, priority, name, or to do first.',
