...
- **Areas of life, in your own words.** Name what matters, give each a colour (from a wide, hue-grouped palette that marks the colours already in use), a note on why it matters, and a place in your priority order. Up to twenty.
...
- **Insights.** A rich, gentle read on how life is going, over a selectable range (week, month, year, all time) or focused on a single area: momentum over time, a full-year calendar of the days you showed up, your busiest days and times, a balance constellation of your whole life, per-habit rhythms with sparklines, and the honest lift and drag of your tugs. It closes with a warm, human reflection written from your own week that never repeats itself. Real numbers, always framed around showing up, never streaks to break.
- **The Bloom garden.** A second view in Insights: every week of your life pressed and kept as its own small bloom, a garden you can scroll back through, computed live from your logs so it stores nothing extra.
- **Made yours.** Eight themes, synced across devices — five by day (Terracotta, Mango Sunshine, Sage Grove, Lavender, Rose Quartz) and three after dark (Indigo Night, Espresso, Forest Night) — plus Harmony's own calendar, time, and choice pickers throughout, so every choice stays in the app rather than dropping to the OS.
