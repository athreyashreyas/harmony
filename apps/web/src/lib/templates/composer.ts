import type { Area, Habit, Template, TemplateCondition, TemplateType, UserProfile, WeatherSummary } from '@harmony/shared';
import { daySegment, type DaySegment } from '../time/dates';
