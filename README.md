...
- **Made yours.** Five themes (Terracotta, Mango Sunshine, Sage Grove, Ocean Blue, Indigo Night), synced across devices; and Harmony's own calendar, time, and choice pickers throughout, so every choice stays in the app rather than dropping to the OS.
